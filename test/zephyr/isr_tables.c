...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0xce45, (ISR)0x1126d}, /* 42 */
	...
	{(const void *)0xcd45, (ISR)0x1126d}, /* 49 */
